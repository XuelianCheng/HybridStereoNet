...
import numpy as np
from models.leastereo.genotypes_3d import PRIMITIVES
from models.leastereo.genotypes_3d import Genotype
from models.leastereo.operations_3d import *
...
class newMatching(nn.Module):
    def __init__(self, network_arch, cell_arch, cell=Cell, args=None):        
        ...
        self._num_layers = 12 #args.mat_num_layers
        self._block_multiplier = 4 #args.mat_block_multiplier
        self._filter_multiplier = 8 #args.mat_filter_multiplier
        
        initial_fm = self._filter_multiplier * self._block_multiplier
        half_initial_fm = initial_fm // 2

        self.stem0 = ConvBR(initial_fm*2, initial_fm, 3, stride=1, padding=1) #initial_fm*2
